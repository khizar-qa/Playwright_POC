...
export class TopMenuPage {
  ...
  constructor(page: Page) {
    ...
    this.searchbar = page.locator(".DocSearch-Search-Icon");
    this.searchdocs = page.getByPlaceholder("Search docs");
    this.search = page.locator("#how-to-get-started");
  }
  ...
  async Search() {
    ...
    await this.searchdocs.fill("Get Started");
    await this.page.waitForTimeout(5000);
